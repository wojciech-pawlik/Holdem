...
import static pl.erfean.holdem.sample.RunController.RUN_HEIGHT;
import static pl.erfean.holdem.sample.RunController.RUN_WIDTH;
...
public class Controller implements Initializable {
    ...
    private static final int[] PLAYER_COUNTS = {2,3,4,5,6,7,8,9,10};

    @Override
    public void initialize(URL location, ResourceBundle resources) {
        IntStream.of(PLAYER_COUNTS).forEach(i -> seatsChoiceBox.getItems().add(i));
...
//        session.close();
    ...
    public void showAddPlayerDialog() {
        ...
        var dialog = createDialog(fxmlLoader, "Add new player");
    ...
    public void showEditPlayerDialog() {
        ...
        var fxmlLoader = createLoader("edit.fxml");
        var dialog = createDialog(fxmlLoader, "Edit player");
        EditController editController = fxmlLoader.getController();
